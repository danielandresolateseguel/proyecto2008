...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeCarousel() {
        ...
        carouselContainer.addEventListener('touchstart', (e) => {
            ...
            // Mantener la transición pero reducir su duración para evitar conflictos
            slidesContainer.style.transition = 'transform 0.1s ease-out';
        }, { passive: true });
        ...
        carouselContainer.addEventListener('touchend', (e) => {
            ...
            const containerWidth = carouselContainer.offsetWidth;
            const swipeThreshold = containerWidth * 0.15; // Reducir umbral para mayor sensibilidad
