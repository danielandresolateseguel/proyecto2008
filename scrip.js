...
document.addEventListener('DOMContentLoaded', function() {
    ...
    productCards.forEach((card) => {
        ...
        function openProductModalFromCard(productCard) {
        ...
        card.addEventListener('touchmove', function(e) {
            ...
            // Si el movimiento es mayor a 15px, considerarlo como deslizamiento
            if (deltaX > 15 || deltaY > 15) {
                touchMoved = true;
            }
        }, { passive: true });
        
        // Manejar final del toque
        card.addEventListener('touchend', function(e) {
            ...
            if (!touchMoved && !touchHandled) {
                touchHandled = true;
                e.preventDefault();
                openProductModalFromCard(this);
            }
        });
        
        // Manejar clicks para dispositivos no táctiles
        card.addEventListener('click', function(e) {
            ...
            // Solo procesar si no fue manejado por touch
            if (!touchHandled) {
                e.preventDefault();
                openProductModalFromCard(this);
            }
